...
class GeneratedCodeFunctionalTest extends FunctionalTest
{
    ...
    public function test_should_generate_classes_and_use_internally()
    {
        ...
        $this->assertTrue(class_exists('Quatrevieux_Form_Fixtures_RequiredParametersRequestInstantiator'));
        $this->assertTrue(class_exists('Quatrevieux_Form_Fixtures_RequiredParametersRequestValidator'));

        $this->assertInstanceOf('Quatrevieux_Form_Fixtures_RequiredParametersRequestInstantiator', (new \ReflectionProperty($form, 'instantiator'))->getValue($form));
