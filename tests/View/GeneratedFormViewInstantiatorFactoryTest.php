...
class Quatrevieux_Form_Fixtures_SimpleRequestViewGeneratorTesting implements Quatrevieux\Form\View\FormViewInstantiatorInterface
{
    ...
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\SimpleRequest', ['foo' => new \Quatrevieux\Form\View\FieldView('foo', $value['foo'] ?? null, ($__tmp_6f4afa00801630e2315251561e35e48c = $errors['foo'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_6f4afa00801630e2315251561e35e48c : null, []), 'bar' => new \Quatrevieux\Form\View\FieldView('bar', $value['bar'] ?? null, ($__tmp_2b71b0f6b364f62d6344a8beead6aeb4 = $errors['bar'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_2b71b0f6b364f62d6344a8beead6aeb4 : null, [])], $value) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\SimpleRequest', ['foo' => new \Quatrevieux\Form\View\FieldView("{$rootField}[foo]", $value['foo'] ?? null, ($__tmp_6f4afa00801630e2315251561e35e48c = $errors['foo'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_6f4afa00801630e2315251561e35e48c : null, []), 'bar' => new \Quatrevieux\Form\View\FieldView("{$rootField}[bar]", $value['bar'] ?? null, ($__tmp_2b71b0f6b364f62d6344a8beead6aeb4 = $errors['bar'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_2b71b0f6b364f62d6344a8beead6aeb4 : null, [])], $value);
    }

    function default(?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\SimpleRequest', ['foo' => new \Quatrevieux\Form\View\FieldView('foo', null, null, []), 'bar' => new \Quatrevieux\Form\View\FieldView('bar', null, null, [])], []) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\SimpleRequest', ['foo' => new \Quatrevieux\Form\View\FieldView("{$rootField}[foo]", null, null, []), 'bar' => new \Quatrevieux\Form\View\FieldView("{$rootField}[bar]", null, null, [])], []);
    }
...
PHP,
    file_get_contents(self::GENERATED_DIR . '/Quatrevieux_Form_Fixtures_SimpleRequestViewGeneratorTesting.php')
        ...
        $this->assertEquals(new FormView(SimpleRequest::class, [
...
class Quatrevieux_Form_Fixtures_WithFieldNameMappingViewGeneratorTesting implements Quatrevieux\Form\View\FormViewInstantiatorInterface
{
    function submitted(array $value, array $errors, ?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithFieldNameMapping', ['myComplexName' => new \Quatrevieux\Form\View\FieldView('my_complex_name', $value['my_complex_name'] ?? null, ($__tmp_6646ce58d572c7d5640134a33c951f4a = $errors['myComplexName'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_6646ce58d572c7d5640134a33c951f4a : null, []), 'otherField' => new \Quatrevieux\Form\View\FieldView('other', $value['other'] ?? null, ($__tmp_989e5265fe2eb9b109bf3a31e4316669 = $errors['otherField'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_989e5265fe2eb9b109bf3a31e4316669 : null, [])], $value) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithFieldNameMapping', ['myComplexName' => new \Quatrevieux\Form\View\FieldView("{$rootField}[my_complex_name]", $value['my_complex_name'] ?? null, ($__tmp_6646ce58d572c7d5640134a33c951f4a = $errors['myComplexName'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_6646ce58d572c7d5640134a33c951f4a : null, []), 'otherField' => new \Quatrevieux\Form\View\FieldView("{$rootField}[other]", $value['other'] ?? null, ($__tmp_989e5265fe2eb9b109bf3a31e4316669 = $errors['otherField'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_989e5265fe2eb9b109bf3a31e4316669 : null, [])], $value);
    }

    function default(?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithFieldNameMapping', ['myComplexName' => new \Quatrevieux\Form\View\FieldView('my_complex_name', null, null, []), 'otherField' => new \Quatrevieux\Form\View\FieldView('other', null, null, [])], []) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithFieldNameMapping', ['myComplexName' => new \Quatrevieux\Form\View\FieldView("{$rootField}[my_complex_name]", null, null, []), 'otherField' => new \Quatrevieux\Form\View\FieldView("{$rootField}[other]", null, null, [])], []);
    }
...
PHP,
        ...
        $this->assertEquals(new FormView(WithFieldNameMapping::class, [
...
class Quatrevieux_Form_Fixtures_FormWithCustomViewViewGeneratorTesting implements Quatrevieux\Form\View\FormViewInstantiatorInterface
{
    function submitted(array $value, array $errors, ?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\FormWithCustomView', ['count' => new \Quatrevieux\Form\View\FieldView('count', $value['count'] ?? null, ($__tmp_5df2c6c85ffea0dcf7dce879c4143ed5 = $errors['count'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5df2c6c85ffea0dcf7dce879c4143ed5 : null, ['min' => 0, 'max' => 100, 'id' => 'form_count', 'type' => 'number']), 'name' => new \Quatrevieux\Form\View\FieldView('name', $value['name'] ?? null ?? 'example', ($__tmp_e32b6614c8f91a4bbb98de16ed0af4b5 = $errors['name'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_e32b6614c8f91a4bbb98de16ed0af4b5 : null, ['id' => 'form_name', 'type' => 'text'])], $value) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\FormWithCustomView', ['count' => new \Quatrevieux\Form\View\FieldView("{$rootField}[count]", $value['count'] ?? null, ($__tmp_5df2c6c85ffea0dcf7dce879c4143ed5 = $errors['count'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5df2c6c85ffea0dcf7dce879c4143ed5 : null, ['min' => 0, 'max' => 100, 'id' => 'form_count', 'type' => 'number']), 'name' => new \Quatrevieux\Form\View\FieldView("{$rootField}[name]", $value['name'] ?? null ?? 'example', ($__tmp_e32b6614c8f91a4bbb98de16ed0af4b5 = $errors['name'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_e32b6614c8f91a4bbb98de16ed0af4b5 : null, ['id' => 'form_name', 'type' => 'text'])], $value);
    }

    function default(?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\FormWithCustomView', ['count' => new \Quatrevieux\Form\View\FieldView('count', null, null, ['min' => 0, 'max' => 100, 'id' => 'form_count', 'type' => 'number']), 'name' => new \Quatrevieux\Form\View\FieldView('name', null ?? 'example', null, ['id' => 'form_name', 'type' => 'text'])], []) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\FormWithCustomView', ['count' => new \Quatrevieux\Form\View\FieldView("{$rootField}[count]", null, null, ['min' => 0, 'max' => 100, 'id' => 'form_count', 'type' => 'number']), 'name' => new \Quatrevieux\Form\View\FieldView("{$rootField}[name]", null ?? 'example', null, ['id' => 'form_name', 'type' => 'text'])], []);
    }
...
PHP,
        ...
        $this->assertEquals(new FormView(FormWithCustomView::class, [
...
class Quatrevieux_Form_Fixtures_WithChoiceRequestViewGeneratorTesting implements Quatrevieux\Form\View\FormViewInstantiatorInterface
{
    ...
    function submitted(array $value, array $errors, ?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView('value', $value['value'] ?? null, ($__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e = $errors['value'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e : null, []))->choices((new \Quatrevieux\Form\Choice\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choiceViews($value['value'] ?? null, $this->transformer->fieldTransformer('value'), $this->registry), $this->registry->getTranslator())], $value) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView("{$rootField}[value]", $value['value'] ?? null, ($__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e = $errors['value'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e : null, []))->choices((new \Quatrevieux\Form\Choice\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choiceViews($value['value'] ?? null, $this->transformer->fieldTransformer('value'), $this->registry), $this->registry->getTranslator())], $value);
    }

    function default(?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView('value', null, null, []))->choices((new \Quatrevieux\Form\Choice\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choiceViews(null, $this->transformer->fieldTransformer('value'), $this->registry), $this->registry->getTranslator())], []) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView("{$rootField}[value]", null, null, []))->choices((new \Quatrevieux\Form\Choice\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choiceViews(null, $this->transformer->fieldTransformer('value'), $this->registry), $this->registry->getTranslator())], []);
    }
...
PHP,
        ...
        $this->assertEquals(new FormView(WithChoiceRequest::class, [
