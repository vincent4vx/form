...
class Quatrevieux_Form_Fixtures_WithChoiceRequestViewGeneratorTesting implements Quatrevieux\Form\View\FormViewInstantiatorInterface
{
    ...
    function submitted(array $value, array $errors, ?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView('value', $value['value'] ?? null, ($__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e = $errors['value'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e : null, []))->choices((new \Quatrevieux\Form\Validator\Constraint\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choices($value['value'] ?? null, $this->transformer->fieldTransformer('value')), $this->registry->getTranslator())], $value) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView("{$rootField}[value]", $value['value'] ?? null, ($__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e = $errors['value'] ?? null) instanceof \Quatrevieux\Form\Validator\FieldError ? $__tmp_5c3b6fd1a41b45355826d3a33c0e6c6e : null, []))->choices((new \Quatrevieux\Form\Validator\Constraint\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choices($value['value'] ?? null, $this->transformer->fieldTransformer('value')), $this->registry->getTranslator())], $value);
    }

    function default(?string $rootField = null): Quatrevieux\Form\View\FormView
    {
        return $rootField === null ? new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView('value', null, null, []))->choices((new \Quatrevieux\Form\Validator\Constraint\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choices(null, $this->transformer->fieldTransformer('value')), $this->registry->getTranslator())], []) :  new \Quatrevieux\Form\View\FormView('Quatrevieux\\Form\\Fixtures\\WithChoiceRequest', ['value' => (new \Quatrevieux\Form\View\FieldView("{$rootField}[value]", null, null, []))->choices((new \Quatrevieux\Form\Validator\Constraint\Choice(choices: ['The answer' => 42, 'The beast' => 666, 'Lost' => 404], message: 'The value is not a valid choice.'))->choices(null, $this->transformer->fieldTransformer('value')), $this->registry->getTranslator())], []);
    }
